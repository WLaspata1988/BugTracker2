...
namespace BugTracker.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            //Give my details ciew a multiselect list of available Project managers
            ...
            var currentSubmitter = projectHelper.UsersInRoleOnProject(project.Id, "Submitter");
            var allSubmitters = roleHelper.UsersInRole("Submitter");
            ViewBag.Submitters = new MultiSelectList(allSubmitters, "Id", "FirstName", currentSubmitter);
